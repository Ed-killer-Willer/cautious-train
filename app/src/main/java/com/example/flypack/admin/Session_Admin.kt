...
class Session_Admin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.admin_session)
...
//Variables creadas vs existentes en el layout
    ...
    fun layout_admin_main (view: View){
    ...
    fun admin_back_user_all (view: View){
        val intent= Intent(this, User_All::class.java).apply{}
        startActivity(intent)
        finish()} // Esto cerrará la actividad actual después de iniciar User_All
    // }


    fun admin_go_recovery_password(view: View){
        val intent= Intent(this, Recovery_Admin::class.java).apply{}
        startActivity(intent)}
