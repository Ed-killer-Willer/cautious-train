...
class Main_Uadmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.uadmin_main)
    ...
    fun go_to_create_uadmin (view: View){
        val intent= Intent(this, Create_Uadmin::class.java).apply{}
        startActivity(intent)}

    fun go_to_rud_uadmin (view: View){
        val intent= Intent(this, Rud_Uadmin ::class.java).apply{}
        startActivity(intent)}

    fun back_main_admin (view: View){
